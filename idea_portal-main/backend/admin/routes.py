...
def dashboard():
    ...
    # ✅ FIXED LOGIC (USE is_approved)
    approved_projects = ResearchProject.query.filter_by(is_approved=True).count()
    pending_projects = ResearchProject.query.filter_by(is_approved=False).count()
